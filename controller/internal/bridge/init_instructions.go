...
// instructionConfigs returns nudge prompt templates and claude-instructions
// config entries that gasboat seeds into the beads daemon.
// Separated from configs() in init.go to keep file sizes under quench limits.
func instructionConfigs() map[string]any {
